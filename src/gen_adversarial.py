...
parser.add_argument('--save_path', type=str, default='../saved/my_adversarial_samples',    help="Directory for saving adv samples")
parser.add_argument('--model_path', type=str, default='../saved/my_train/model.h5',            help='Path to target model')
parser.add_argument('--log_path', type=str, default='../saved/my_adversarial_log.csv',     help="[csv file] Adv sample generation log")
...
def gen_adv_samples(model, fn_list, pad_percent=0.1, step_size=0.001, thres=0.5):
    ...
    inp2emb = K.function([model.input],
                         [emb_layer.output])  # [function] Map sequence to embedding
